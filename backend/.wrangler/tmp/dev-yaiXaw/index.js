...
var require_edge = __commonJS({
  "node_modules/@prisma/client/runtime/edge.js"(exports, module) {
    ...
    var ur = /* @__PURE__ */ __name((e, t) => {
      for (var r in t)
        Ct(e, r, { get: t[r], enumerable: true });
    }, "ur");
    ...
    var Oi = Le((Ye) => {
      ...
      var yi = /* @__PURE__ */ __name((e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), "yi"), ka = yi((e) => {
        ...
        function g(R) {
          ...
          for (Q = 0; Q < B; Q += 4)
            S = r[R.charCodeAt(Q)] << 18 | r[R.charCodeAt(Q + 1)] << 12 | r[R.charCodeAt(Q + 2)] << 6 | r[R.charCodeAt(Q + 3)], D[L++] = S >> 16 & 255, D[L++] = S >> 8 & 255, D[L++] = S & 255;
      ...
      function Pi(e, t, r, n, i) {
        ...
        if (typeof t == "number")
          return t = t & 255, typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(e, t, r) : Uint8Array.prototype.lastIndexOf.call(e, t, r) : fi(e, [t], r, n, i);
    ...
    var W = /* @__PURE__ */ __name(class e extends Error {
      constructor(r, n, i) {
        super(r);
    ...
    p();
    m();
    var oe = /* @__PURE__ */ __name(class extends Error {
    ...
    A.cubeRoot = A.cbrt = function() {
      ...
      if (!g.isFinite() || g.isZero())
        return new h(g);
      for (_ = false, o = g.s * H(g.s * g, 1 / 3), !o || Math.abs(o) == 1 / 0 ? (r = Y(g.d), e = g.e, (o = (e - r.length + 1) % 3) && (r += o == 1 || o == -2 ? "0" : "00"), o = H(r, 1 / 3), e = ee((e + 1) / 3) - (e % 3 == (e < 0 ? -1 : 2)), o == 1 / 0 ? r = "5e" + e : (r = o.toExponential(), r = r.slice(0, r.indexOf("e") + 1) + e), n = new h(r), n.s = g.s) : n = new h(o.toString()), s = (e = h.precision) + 3; ; )
    ...
    A.inverseTangent = A.atan = function() {
      ...
      for (_ = false, t = Math.ceil(a / O), n = 1, l = f.times(f), s = new g(f), i = f; e !== -1; )
    ...
    A.logarithm = A.log = function(e) {
      ...
      if (_ = false, a = h + k, s = Oe(f, a), n = t ? vr(g, a + 10) : Oe(e, a), l = V(s, n, a, 1), Dt(l.d, i = h, T))
        do
    ...
    A.squareRoot = A.sqrt = function() {
      ...
      for (_ = false, f = Math.sqrt(+s), f == 0 || f == 1 / 0 ? (t = Y(a), (t.length + l) % 2 == 0 && (t += "0"), f = Math.sqrt(t), l = ee((l + 1) / 2) - (l < 0 || l % 2), f == 1 / 0 ? t = "5e" + l : (t = f.toExponential(), t = t.slice(0, t.indexOf("e") + 1) + l), n = new g(t)) : n = new g(f.toString()), r = (l = g.precision) + 3; ; )
    ...
    A.times = A.mul = function(e) {
      ...
      for (r = ee(g.e / O) + ee(e.e / O), l = T.length, f = k.length, l < f && (o = T, T = k, k = o, s = l, l = f, f = s), o = [], s = l + f, n = s; n--; )
        o.push(0);
      for (n = f; --n >= 0; ) {
        for (t = 0, i = l + n; i > n; )
    ...
    A.toFraction = function(e) {
      ...
      if (!R)
        return new S(k);
      if (f = r = new S(1), n = l = new S(0), t = new S(n), o = t.e = vo(R) - k.e - 1, s = o % O, t.d[0] = H(10, s < 0 ? O + s : s), e == null)
        e = o > 0 ? t : f;
      else {
      ...
      for (_ = false, a = new S(Y(R)), g = S.precision, S.precision = o = R.length * O * 2; h = V(a, t, 0, 1, 1), i = r.plus(h.times(n)), i.cmp(e) != 1; )
    ...
    function vr(e, t, r) {
      if (t > $l)
        throw _ = true, r && (e.precision = r), Error(Eo);
    ...
    function Nn(e, t) {
      ...
      for (t == null ? (_ = false, l = R) : l = t, a = new T(0.03125); e.e > -2; )
        e = e.times(a), h += 5;
        ...
        if (o = I(o.times(e), l, 1), r = r.times(++g), a = s.plus(V(o, r, l, 1)), Y(a.d).slice(0, l) === Y(s.d).slice(0, l)) {
          ...
          if (t == null)
            if (f < 3 && Dt(s.d, l - n, k, f))
              ...
              return I(s, T.precision = R, k, _ = true);
          else
    ...
    function Oe(e, t) {
      ...
      if (t == null ? (_ = false, g = D) : g = t, N.precision = g += R, r = Y(M), n = r.charAt(0), Math.abs(o = S.e) < 15e14) {
        ...
        return f = vr(N, g + 2, D).times(o + ""), S = Oe(new N(n + "." + r.slice(1)), g - R).plus(f), N.precision = D, t == null ? I(S, D, U, _ = true) : S;
        ...
        if (s = I(s.times(T), g, 1), f = l.plus(V(s, new N(i), g, 1)), Y(f.d).slice(0, g) === Y(l.d).slice(0, g))
          if (l = l.times(2), o !== 0 && (l = l.plus(vr(N, g + 2, D).times(o + ""))), l = V(l, new N(k), g, 1), t == null)
            if (Dt(l.d, g - R, U, a))
              ...
              return I(l, N.precision = D, U, _ = true);
          else
    ...
    function jl(e, t) {
      ...
      if (Bl.test(t))
        ...
        throw Error(De + t);
      for (o = t.search(/p/i), o > 0 ? (l = +t.slice(o + 1), t = t.substring(2, o)) : t = t.slice(2), o = t.indexOf("."), s = o >= 0, n = e.constructor, s && (t = t.replace(".", ""), a = t.length, o = a - o, i = To(n, new n(r), o, o * 2)), f = Er(t, r, me), g = f.length - 1, o = g; f[o] === 0; --o)
        f.pop();
    ...
    function So(e) {
      ...
      function i(o) {
        ...
        if (l === "string")
          return (a = o.charCodeAt(0)) === 45 ? (o = o.slice(1), f.s = -1) : (a === 43 && (o = o.slice(1)), f.s = 1), Po.test(o) ? br(f, o) : jl(f, o);
        if (l === "bigint")
...
Note that ${s.bold("include")} statements only accept relation fields.`, a;
    ...
    var Lt = /* @__PURE__ */ __name(class extends Ae {
      _getNamespace() {
        return "NullTypes";
      }
    }, "Lt");
    var Bt = /* @__PURE__ */ __name(class extends Lt {
    }, "Bt");
    Bn(Bt, "DbNull");
    var qt = /* @__PURE__ */ __name(class extends Lt {
    }, "qt");
    Bn(qt, "JsonNull");
    var Ut = /* @__PURE__ */ __name(class extends Lt {
    }, "Ut");
    Bn(Ut, "AnyNull");
...
`);
    ...
    __name($n, "$n");
    var Un = /* @__PURE__ */ __name(class e {
      constructor(t) {
        this.params = t;
        w(this, "modelOrType");
    ...
    p();
    m();
    var ae = /* @__PURE__ */ __name(class e {
      constructor(t, r) {
...
Prisma Accelerate has built-in connection pooling to prevent such errors: https://pris.ly/client/error-accelerate`), r;
    ...
    function Ts({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: i, globalOmit: o }) {
      return n.isEmpty() || e == null || typeof e != "object" || !i.models[t] ? e : zr({ result: e, args: r ?? {}, modelName: t, runtimeDataModel: i, visitor: (a, l, f) => {
        let g = be(l);
    ...
    function Ss(e, t, r, n = 0) {
      return e._createPrismaPromise((i) => {
        ...
        return "transaction" in t && i !== void 0 && (t.transaction?.kind === "batch" && t.transaction.lock.then(), t.transaction = i), n === r.length ? e._executeRequest(t) : r[n]({ model: t.model, operation: t.model ? t.action : t.clientMethod, args: As(t.args ?? {}), __internalParams: t, query: (s, a = t) => {
...
To solve this, provide the connection string directly: https://pris.ly/d/cloudflare-datasource-url`, n) : new W(`error: Environment variable not found: ${s.fromEnvVar}.`, n);
    ...
    p();
    m();
    var Zr = /* @__PURE__ */ __name(class extends Error {
      constructor(r, n) {
        super(r);
        w(this, "clientVersion");
        w(this, "cause");
    ...
    var le = /* @__PURE__ */ __name(class extends Zr {
      constructor(r, n) {
        super(r, n);
        w(this, "isRetryable");
    ...
    __name(q, "q");
    var wt = /* @__PURE__ */ __name(class extends le {
      constructor(r) {
    ...
    p();
    m();
    var Ve = /* @__PURE__ */ __name(class extends le {
      constructor(r, n) {
        super(r, q(n, false));
    ...
    p();
    m();
    var je = /* @__PURE__ */ __name(class extends le {
      constructor(r, n) {
        super(r, q(n, false));
    ...
    p();
    m();
    var J = /* @__PURE__ */ __name(class extends le {
      constructor(r, n) {
        super(r, n);
        w(this, "response");
    ...
    async function ir(e, t) {
      ...
      if (e.status === 401 || e.status === 403)
        throw new rr(r, bt(ri, n));
      if (e.status === 404)
        return new tr(r, bt(ei, n));
      if (e.status === 429)
        throw new nr(r, bt(ni, n));
      if (e.status === 504)
        throw new Zt(r, bt(Xn, n));
      if (e.status >= 500)
        throw new Et(r, bt(ti, n));
      if (e.status >= 400)
    ...
    p();
    m();
    var or = /* @__PURE__ */ __name(class extends le {
      constructor(r, n) {
...
`), { clientVersion: t.clientVersion });
    ...
    function Ks(e, t) {
      ...
      if (up(e))
        return { prisma__type: "bytes", prisma__value: E.Buffer.from(e).toString("base64") };
      if (ArrayBuffer.isView(e)) {
        let { buffer: r, byteOffset: n, byteLength: i } = e;
...
Read more at https://pris.ly/d/client-constructor`), this.name = "PrismaClientConstructorValidationError";
    ...
    var bp = { datasources: (e, { datasourceNames: t }) => {
      if (e) {
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\janim\\Codes\\project\\blog-web\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\janim\\Codes\\project\\blog-web\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
      ...
      "inlineSchemaHash": "2d5e4ea005c9260c2dfead0f012d42b9a8a76a8f52f8efc9673b5264a7e99b4e",
      "copyEngine": false
    };
    config.dirname = "/";
...
// .wrangler/tmp/bundle-wqBWQ2/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-wqBWQ2/middleware-insertion-facade.js
init_modules_watch_stub();
...
var verifyFromJwks = /* @__PURE__ */ __name(async (token, options, init) => {
  ...
  return await verify2(token, matchingKey, matchingKey.alg);
}, "verifyFromJwks");
...
// node_modules/hono/dist/utils/jwt/index.js
var Jwt = { sign, verify: verify2, decode, verifyFromJwks };
...
// controllers/middlerware.ts
init_modules_watch_stub();
var middleware = /* @__PURE__ */ __name(async (c, next) => {
